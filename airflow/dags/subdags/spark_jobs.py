...
def spark_jobs_subdag(
    ...
    session_kind,
    *args, **kwargs):
    """SubDAG para procesar datos con Spark"""
    ...
    def create_task(script_name):
        """Devuelve un operador que ejecuta el script Spark con el nombre especificado."""

        with open(f'/Users/juand1925/airflow/dags/scripts/{script_name}.py', 'r') as f:
            spark_script = f.read()
